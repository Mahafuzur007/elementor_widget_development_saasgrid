...
final class ElementorPlugin
{
    ...
    public function init()
    {
        ...
        add_action('elementor/elements/categories_registered', [$this, 'custom_elementor_widget_categories']);
    }
    ...
    function custom_elementor_widget_categories($elements_manager)
    {
        ...
        $elements_manager->add_category(
            'custom-category',
            [
                'title' => esc_html__('SaasGrid', 'textdomain'),
                'icon' => 'fa fa-plug',
            ]
        );
    }
    ...
    public function register_widgets($widgets_manager)
    {
        ...
        $widgets_manager->register(new Saas_Banner_Widget());
        $widgets_manager->register(new section_heading_Widget());
        $widgets_manager->register(new section_feature_Widget());
        $widgets_manager->register(new section_pricing_Widget());
        $widgets_manager->register(new section_button_Widget());
        $widgets_manager->register(new section_header_Widget());
    }
}
